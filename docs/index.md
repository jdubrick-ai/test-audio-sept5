...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-audio-sept5](https://github.com/jdubrick-ai/test-audio-sept5)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-audio-sept5-gitops](https://github.com/jdubrick-ai/test-audio-sept5-gitops)

# **Usage**

To access the test-audio-sept5 application that was deployed using the Software Template, complete the following instructions:
